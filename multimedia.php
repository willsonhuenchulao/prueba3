...
<body>
  ...
  <div class="container mt-5 pd-5">
    <h2 class="text-center">Registrar contenido para la web</h2>
    <hr>

    <form action="recibVideoYoutube.php" method="post">
    <div class="form-group">
      <label for="nombreVideo">Nombre del Contenido</label>
    ...
    <div class="form-group">
      <label for="nombreVideo">Link del contenido</label>
      <input type="text" name="nombreVideo" class="form-control">
    </div>

    <div class="form-group">
      <label for="nombreVideo">Tema de interes</label>
      <input type="text" name="nombreVideo" class="form-control">
    </div>
    ...
    <table class="table table-hover table-striped">
      ...
      <?php
        ...
        <tr>
          ...
          <td>
            <a href="multimedia.php?idVideo=<?php echo $dataVideo['id']; ?>" class="btn btn-danger">Crear Video</a>
          </td>
          <td>
